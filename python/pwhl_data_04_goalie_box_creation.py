"""Stage 04 — pwhl `goalie_box` season dataset (parse + compile ONE family).

Thin numbered entry over ``pwhl_data_build.season`` restricted to the ``goalie_box``
...
Usage::
    ...
    python -m pwhl_data_04_goalie_box_creation -s 2026
    scripts/pwhl_data.sh 04
"""
