"""Stage 13 — pwhl `shootout` season dataset (parse + compile ONE family).

Thin numbered entry over ``pwhl_data_build.season`` restricted to the ``shootout``
...
Usage::
    ...
    python -m pwhl_data_13_shootout_creation -s 2026
    scripts/pwhl_data.sh 13
"""
